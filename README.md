# ScanBIN Android [![CI](https://github.com/SEPAdigital/scanbin-android/actions/workflows/workflow.yml/badge.svg?branch=master)](https://github.com/SEPAdigital/scanbin-android/actions/workflows/workflow.yml)
...
- Copyright (c) 2022 Dalafiari Samuel - Original Creator
- Copyright (c) 2025 Rene Kapusta - Additional Development and Modifications

This project may contain code generated by artificial intelligence tools.
Such AI-generated code is subject to the same MIT License terms as the rest of the project.
